...
#testiranje
with db_session:
    o1 = Answers(answer ="10*100", related_question=6, the_value=False)
    o2 = Answers(answer ="100**100", related_question=6, the_value=False)
    o3 = Answers(answer ="10**100", related_question=6, the_value=True)
    o4 = Answers(answer ="100*5/5", related_question=6, the_value=False)
